...
class Numpy(FunctionLibraryBase):
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', [], {'constraint': '1'}),
                    meta={'Category': 'numpy|array', 'Keywords': ['list', 'interval']})
    def linSpace(
            start=('FloatPin', 0.),
            stop=('FloatPin', 10),
            num=('IntPin', 50)
    ...
    # @staticmethod
    # @IMPLEMENT_NODE(returns=('VectorPin', [], {}),
    #                 meta={'Category': 'numpy|array', 'Keywords': ['list', 'interval']})
    # def linSpace2D(
    #         start=('FloatPin', 0.),
    #         stop=('FloatPin', 10),
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', [2.], {'constraint': '1',
                                                "enabledOptions": PinOptions.ArraySupported | PinOptions.AllowAny}),
                    meta={'Category': 'numpy|random', 'Keywords': ['list', 'random']})
    ...
    # @staticmethod
    # @IMPLEMENT_NODE(returns=('VectorPin', [], {'constraint': '1',
    #                                            "enabledOptions": PinOptions.ArraySupported | PinOptions.AllowAny}),
    #                 meta={'Category': 'numpy|array', 'Keywords': ['list', 'random']})
    # def zip(
    ...
    # @staticmethod
    # @IMPLEMENT_NODE(returns=('RotationPin', [], {'constraint': '1',
    #                                              "enabledOptions": PinOptions.ArraySupported | PinOptions.AllowAny}),
    #                 meta={'Category': 'numpy|array', 'Keywords': ['list', 'random']})
    # def zipRotation(
    #         x=('FloatPin', [0], {PinSpecifires.ENABLED_OPTIONS: PinOptions.ArraySupported}),
    ...
    @IMPLEMENT_NODE(returns=('FloatPin', [], {'constraint': '1',
                                              "enabledOptions": PinOptions.ArraySupported | PinOptions.AllowAny}),
                    meta={'Category': 'numpy|operations',
                          'Keywords': ['list', 'scale', 'multiply']})
    def scale(
    ...
    @IMPLEMENT_NODE(returns=('FloatPin', [], {'constraint': '1',
                                              "enabledOptions": PinOptions.ArraySupported | PinOptions.AllowAny}),
                    meta={'Category': 'numpy|trigonometry',
                          'Keywords': ['list', 'scale', 'multiply']})
    def sin(
            data=('FloatPin', [0], {PinSpecifires.ENABLED_OPTIONS: PinOptions.ArraySupported}),
            a=('FloatPin', 1.),
    ...
    @IMPLEMENT_NODE(returns=('FloatPin', [], {'constraint': '1',
                    ...
                    meta={'Category': 'numpy|trigonometry',
                          'Keywords': ['list', 'scale', 'multiply']})
    def rad2deg(
            radians=('FloatPin', [0], {PinSpecifires.ENABLED_OPTIONS: PinOptions.ArraySupported})):
        """radians to degree"""
    ...
    @IMPLEMENT_NODE(returns=('FloatPin', [], {'constraint': '1',
                                              "enabledOptions": PinOptions.ArraySupported | PinOptions.AllowAny}),
                    meta={'Category': 'numpy|trigonometry',
                          'Keywords': ['degree', 'radian', 'angle']})
    def deg2rad(
            degree=('FloatPin', [0], {PinSpecifires.ENABLED_OPTIONS: PinOptions.ArraySupported})):
        """
        degree to radians
        """
    ...
    @IMPLEMENT_NODE(returns=('FloatPin', [], {'constraint': '1',
                                              "enabledOptions": PinOptions.ArraySupported | PinOptions.AllowAny}),
                    meta={'Category': 'numpy|interpolate',
                          'Keywords': ['list', 'scale', 'multiply']})
    def interp_lin(
            x=('FloatPin', [0, 0.5, 1., 1.5],
               {PinSpecifires.ENABLED_OPTIONS: PinOptions.ArraySupported}),
